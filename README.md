...
Repository: https://github.com/pradhumna-gif/storeops-harness
...
| Screenshots and logs | `evidence/` (index: `evidence/README.md`) |
| Audit trail index | `.harness/reviews/README.md` |
| CI pipeline (independent final gate) | `.github/workflows/ci.yml` |
